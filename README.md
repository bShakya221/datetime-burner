...
4. **EXIF Metadata Parsing & HEIC Support**: Automatically extracts date and time metadata using `exifr`, supporting JPEG, PNG, and HEIC/HEIF photos (decoded client-side via `heic2any`).
...
* **Libraries**:
  ...
  * [heic2any](https://github.com/alexcorvi/heic2any) (CDN)
